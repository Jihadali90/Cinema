...
namespace Cinema_APP.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult MovieDetails(int? id)
        {
            ...
            var relatedMovies = _context.Movies
                ...
                Skip(0).
                Take (2);
           var MinPrice = movie.Price - movie.Price * 10/ 100;
            var MaxPrice = movie.Price + movie.Price * 10 / 100;
            var RelatedPrices = _context.Movies
                 .Where(e => e.Price >= MinPrice && e.Price <= MaxPrice && e.Id != movie.Id)
                 .Take(2)
                 . Skip(0);
            ...
            return View(new MoviewithRelatedVM
            {
                ...
                Movie = movie,
                RelatedPrices = RelatedPrices.ToList()
            });
